...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('add_item_watchlist')
        .setDescription('Add item on Watchlist')
    ...
    async execute(interaction) {
        ...
        axios.patch("http://localhost:3000/watchlist/addItem?itemID=" + idItem + "&watchlistID=" + idWatchlist + "&state=" + option);
        const validateEmbed = new EmbedBuilder()
            validateEmbed.setColor("#00F000")
            validateEmbed.addFields({name:"Item added", value : " "})
